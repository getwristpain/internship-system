...
<div class="flex flex-col gap-5 p-4 py-10 items-center justify-center h-screen sm max-w-sm self-center">
    {{-- Back Button --}}
    <div>
        <x-secondary-button class="absolute top-10 left-10 font-light hover:bg-black hover:text-white"
    ...
    <div class="flex flex-col gap-2 text-center my-5 w-full">
        ...
        <p>Kamu butuh <u title="Klik Pusat Bantuan jika kamu tidak memilikinya.">kunci akses</u> untuk masuk.</p>
    </div>
